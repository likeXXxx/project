...
func InitMysql() {
	...
	orm.RegisterModel(new(Teacher), new(OManager), new(Organization), new(IManager), new(Master), new(Project), new(AbolitionProject), new(ProjectInvite), new(MasterAudit))
